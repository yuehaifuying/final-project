                ...
                success: function (data) {
                    $.each(data, function (index, first) {
                        ...
                        $.each(first.menus, function (index2, second) {
                            child += "<a class='easyui-linkbutton' onclick='addtabs("+JSON.stringify(first)+");' " +
                                "data-options=\"iconCls:'"+first.iconCls+"',plain:true\" " +
                                "style='border: 1px #369eff solid;width: 93%;margin: 5px 5px'>"+first.title+"</a><br>";
...
<div data-options="region:'north',split:true" style="height:60px;background-color:  #5C160C">
    ...
    <div style="font-size: 16px;color: #FAF7F7;font-family: 楷体;width: 300px;float:right;padding-top:15px"><c:if test="${not empty sessionScope.loginok}">欢迎您:0号${sessionScope.user.name}</c:if><c:if test="${empty sessionScope.user}">请登录</c:if>
...
<div data-options="region:'south',split:true" style="height: 40px;background: #5C160C">
    <div style="text-align: center;font-size:15px; color: #FAF7F7;font-family: 楷体">&copy;百知教育 htf@zparkhr.com.cn  1号</div>
</div>

<div data-options="region:'west',title:'导航菜单',split:true" style="width:220px;">
    <div id="aa" class="easyui-accordion" data-options="fit:true">2号
...
<div data-options="region:'center'">
    <div id="tt" class="easyui-tabs" data-options="fit:true,narrow:true,pill:true">
        <div id="ddd" title="主页" data-options="iconCls:'icon-neighbourhood',"
             style=" background-image : url(${pageContext.request.contextPath}/main/image/shouye.jpg);background-repeat: no-repeat;background-size:100% 100%;">3号</div>
    </div>
